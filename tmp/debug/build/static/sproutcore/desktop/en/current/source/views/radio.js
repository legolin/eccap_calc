  ...
  render: function(context, firstTime) {
    ...
    if (firstTime) {
      ...
      for(idx=0;idx<itemsLength;idx++) {
        ...
        icon = item[3];
        if (icon) {
          url = (icon.indexOf('/')>=0) ? icon : '/static/sproutcore/foundation/en/current/blank.gif?1257446873';
        ...
        var blankImage = '/static/sproutcore/foundation/en/current/blank.gif?1257446873';
