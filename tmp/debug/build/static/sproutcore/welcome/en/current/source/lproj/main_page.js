    ...
    contentView: SC.View.design({
      ...
      icon: SC.View.design({
        ...
        render: function(context, firstTime) {
          context.attr('src', '/static/sproutcore/foundation/en/current/images/sproutcore-logo.png?1257446873');
        }
      }),
...
; if ((typeof SC !== 'undefined') && SC && SC.scriptDidLoad) SC.scriptDidLoad('sproutcore/welcome');